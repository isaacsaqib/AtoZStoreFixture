class ListingsController < ApplicationController
	...
	def index
		...
		# @listings_pharmacy_displays_pictures = Listing.find_by(:id => 3)
		...
		# @listings_security_mirrors_pictures = Listing.find_by(:id => 4)
		...
		# @listings_shopping_carts_and_baskets_pictures = Listing.find_by(:id => 5)
		...
		# @listings_showcases_pictures = Listing.find_by(:id => 6)
		...
		# @listings_slatwall_and_accessories_pictures = Listing.find_by(:id => 7)
